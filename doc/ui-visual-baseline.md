...
- Relative timestamps use “A few moments ago” below one minute, elapsed minutes below one hour, elapsed hours below 24 hours, then local-calendar Yesterday/day counts without an age cutoff. Labels refresh every minute without interrupting screen readers or rebuilding cards.
